...
- Same as j = n -1 which means the last valid element of the nums2

- Merging it in the variable k. k = m + n - 1 where we have to put the largest element each time at the last index. 
